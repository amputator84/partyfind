...
async def handle_button_click(message: types.Message):
    ...
    url = f'https://api.vk.com/method/wall.post?v=5.107&owner_id=-{owner_id}&access_token={vkToken}&from_group=1&message={encoded_txtUrl}&publish_date={tomorrow_milliseconds}'
    print(url)
